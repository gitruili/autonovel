...
# Note: No world sketch or character input — this script runs BEFORE world/character generation.
# The outline is derived purely from seed.txt. World and character details are filled
# in later by gen_world_lf.py and gen_characters_lf.py based on the completed outline.
...
注意：世界设定和角色注册表均尚未生成。请根据种子概念中隐含的时代背景、
社会环境、人物关系以及你对{genre.display_name}题材的理解，自行确定故事的时空设定和角色关系。
你不需为反派和配角取具体名字——用身份标签替代
